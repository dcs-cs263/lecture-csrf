...
public class Database {
    ...
    private ArrayList<DCSNews> news;
    ...
    public Database() {
        ...
        this.news = new ArrayList<DCSNews>();
    }
    ...
    public void removeUser(DCSUser user) {
    ...
    public void addNews(DCSNews news) {
        this.news.add(news);
    }

    public Iterable<DCSNews> getNews() {
        return this.news;
    }
}
